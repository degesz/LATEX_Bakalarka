...
což je operační zesilovač, který vytváří virtuální zem \vizobr{fig:autobal_bridge}. \cite{KeysightImpedanceHandbook}
...
Jako zástupce byl vybrán přistroj LCX200 od firmy Rhode\&Schwarz \vizobr{fig:rhode_lcr}.
...
\begin{figure}[H]
    ...
    \caption{Stolní měřič Rhode\&Schwarz LCX200 \cite{RS_LCX_Datasheet}}
    \label{fig:rhode_lcr}
\end{figure}
