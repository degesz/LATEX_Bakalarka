...
Činitel kvality $Q$ (quality factor) vyjadřuje poměr mezi reaktivní a rezistivní složkou impedance. Pro cívky a kondenzátory se definuje jako:
\begin{equation}
...
Tato veličina se často používá pro charakterizaci kondenzátorů, kde vyjadřuje poměr ztrátové energie k energii uložené v elektrickém poli.

\subsection{Ekvivalentní sériový odpor}

Ekvivalentní sériový odpor \acs{ESR} (Equivalent Series Resistance) představuje rezistivní složku impedance v sériovém náhradním modelu součástky. Pro kondenzátory a cívky je \acs{ESR} důležitým parametrem, který charakterizuje jejich ztráty:
\begin{equation}
\text{ESR} = \text{Re}(Z)
\end{equation}
