...
Pro správné vzorkování signálu je nutné dodržet Nyquistův-Shannonův teorém \cite[str.~11]{Shannon1949}, který říká, že vzorkovací frekvence $f_vz$ musí být alespoň dvojnásobkem nejvyšší frekvence v signálu $f_{max}$:
\begin{equation}
...
Tomu lze předejít použitím antialiasingového filtru před \acs{A/D} převodníkem, který odstraní frekvence vyšší než $\frac{f_s}{2}$.
