...
Pro správné vzorkování signálu je nutné dodržet Nyquistův-Shannonův teorém \cite[kap.~3]{smith_dsp_guide}, který říká, že vzorkovací frekvence $f_vz$ musí být alespoň dvojnásobkem nejvyšší frekvence v signálu $f_{max}$:
\begin{equation}
