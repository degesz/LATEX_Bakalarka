...
Tato kapitola se zabývá obecnou implementací analogové měřící části zařízení.
...
Ústřední částí měřícího obvodu je samovyvažovací můstek, který se chová jako převodník proudu na napětí. Skládá se z \acs{OZ} a referenčního rezistoru.
