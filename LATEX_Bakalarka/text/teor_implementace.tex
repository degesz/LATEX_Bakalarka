...
\begin{enumerate}
    ...
    \end{equation}
    kde $f_{max}$ je maximální měřená frekvence signálu a $U_p$ je jeho špičková amplituda. \cite[str.~248]{ArtOfElectronics}
...
\begin{itemize}
    ...
    Nevýhodou je jejich pomalé přepínání (typicky $5$--$10\ \text{ms}$), omezená životnost a vyšší cena. \cite{citrelay_j104d}
