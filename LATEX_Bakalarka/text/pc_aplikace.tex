...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{obrazky/basic_meas_inv.png}
...
Výsledky se zobrazí v pravé dolní části. Aplikace z impedance také odvodí hodnoty sériového odporu a indukčnosti nebo kapacity. Výpočet probíhá podle vzorců:
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=\textwidth]{obrazky/stats_meas_inv.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{obrazky/integrovany_terminal_inv.png}
