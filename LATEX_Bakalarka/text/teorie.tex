...
pak musí být napětí mezi větvemi nulové.
...
Princip této metody je výpočet hodnoty neznámé impedance z naměřených hodnot napětí a proudu podle ohmova zákona.
...
což je operační zesilovač, který vytváří virtuální zem.
...
Jako zástupce nejlevnější třídy byl vybrán tester LCR-T4. Tento přístroj neměří přímo impedanci,
...
Jako zástupce byl vybrán přistroj LCX200 od firmy Rhode\&Schwarz.
...
Většina stolních měřičů také podporuje připojení do sítě LAN a automatizaci měření.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\textwidth]{obrazky/Rhode_schwarz-LCX200.jpg}
    \caption{Stolní měřič Rhode\&Schwarz LCX200}
    \label{fig:rhode_lcr}
\end{figure}
\begin{table}[h!]
    \centering
